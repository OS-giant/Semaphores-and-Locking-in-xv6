...
int main(int argc, char *argv[]){
   ...
   f:	89 e5                	mov    %esp,%ebp
  11:	51                   	push   %ecx
  12:	83 ec 44             	sub    $0x44,%esp
    struct condvar condvar;

    int index = 0;
    int pid = fork();
  15:	e8 41 03 00 00       	call   35b <fork>
    if (pid < 0) {
  1a:	85 c0                	test   %eax,%eax
  1c:	78 67                	js     85 <main+0x85>
        printf(1, "Error forking child.\n");
    }

    else if (pid == 0) {
  1e:	75 34                	jne    54 <main+0x54>
        int pid1 = fork();
  20:	e8 36 03 00 00       	call   35b <fork>
        if(pid1 == 0){
  25:	85 c0                	test   %eax,%eax
  27:	75 72                	jne    9b <main+0x9b>
            int pid1 = fork();
  29:	e8 2d 03 00 00       	call   35b <fork>
            if(pid1 == 0){
  ...
  39:	6a 01                	push   $0x1
  3b:	6a 00                	push   $0x0
  3d:	e8 d1 03 00 00       	call   413 <semaphore_init>
                writer(1,&condvar);
  42:	58                   	pop    %eax
  ...
  47:	50                   	push   %eax
  48:	6a 01                	push   $0x1
  4a:	e8 f4 03 00 00       	call   443 <writer>
                index++;
  4f:	83 c4 10             	add    $0x10,%esp
  52:	eb 42                	jmp    96 <main+0x96>
            wait();
        }
    }
        ...
        int pid1 = fork();
  54:	e8 02 03 00 00       	call   35b <fork>

        if(pid1 == 0) {
  59:	85 c0                	test   %eax,%eax
  5b:	74 61                	je     be <main+0xbe>
            index++;
            writer(0,&condvar);
        }
  ...
  60:	6a 05                	push   $0x5
  62:	6a 00                	push   $0x0
  64:	e8 aa 03 00 00       	call   413 <semaphore_init>
            index++;
            reader(0,&condvar);
  69:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  6c:	5a                   	pop    %edx
  6d:	59                   	pop    %ecx
  6e:	50                   	push   %eax
  6f:	6a 00                	push   $0x0
  71:	e8 c5 03 00 00       	call   43b <reader>
            wait();
  76:	e8 f0 02 00 00       	call   36b <wait>
  7b:	83 c4 10             	add    $0x10,%esp
        }

        wait();
  7e:	e8 e8 02 00 00       	call   36b <wait>
  83:	eb 11                	jmp    96 <main+0x96>
        printf(1, "Error forking child.\n");
  85:	51                   	push   %ecx
  86:	51                   	push   %ecx
  87:	68 68 08 00 00       	push   $0x868
  8c:	6a 01                	push   $0x1
  ...
  93:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  96:	e8 c8 02 00 00       	call   363 <exit>
            semaphore_init(index, 5, 0);
  9b:	51                   	push   %ecx
  9c:	6a 00                	push   $0x0
  9e:	6a 05                	push   $0x5
  a0:	6a 00                	push   $0x0
  a2:	e8 6c 03 00 00       	call   413 <semaphore_init>
            reader(1,&condvar);
  a7:	58                   	pop    %eax
  a8:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  ab:	5a                   	pop    %edx
  ac:	50                   	push   %eax
  ad:	6a 01                	push   $0x1
  af:	e8 87 03 00 00       	call   43b <reader>
            wait();
  b4:	e8 b2 02 00 00       	call   36b <wait>
  b9:	83 c4 10             	add    $0x10,%esp
  bc:	eb d8                	jmp    96 <main+0x96>
            semaphore_init(index, 1, 0);
  be:	50                   	push   %eax
  bf:	6a 00                	push   $0x0
  c1:	6a 01                	push   $0x1
  c3:	6a 00                	push   $0x0
  c5:	e8 49 03 00 00       	call   413 <semaphore_init>
            writer(0,&condvar);
  ca:	58                   	pop    %eax
  cb:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  ce:	5a                   	pop    %edx
  cf:	50                   	push   %eax
  d0:	6a 00                	push   $0x0
  d2:	e8 6c 03 00 00       	call   443 <writer>
  d7:	83 c4 10             	add    $0x10,%esp
  da:	eb a2                	jmp    7e <main+0x7e>
                semaphore_init(index, 5, 0);
  dc:	51                   	push   %ecx
  dd:	6a 00                	push   $0x0
  df:	6a 05                	push   $0x5
  e1:	6a 00                	push   $0x0
  e3:	e8 2b 03 00 00       	call   413 <semaphore_init>
                reader(2,&condvar);
  e8:	58                   	pop    %eax
  e9:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  ec:	5a                   	pop    %edx
  ed:	50                   	push   %eax
  ee:	6a 02                	push   $0x2
  f0:	e8 46 03 00 00       	call   43b <reader>
                wait();
  f5:	e8 71 02 00 00       	call   36b <wait>
  fa:	83 c4 10             	add    $0x10,%esp
  fd:	eb 97                	jmp    96 <main+0x96>
  ff:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb 7e 08 00 00       	mov    $0x87e,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 74a:	a3 30 0b 00 00       	mov    %eax,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	a1 30 0b 00 00       	mov    0xb30,%eax
 ...
 814:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 817:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 ...
 82e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf 34 0b 00 00       	mov    $0xb34,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 84b:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 852:	00 00 00 
    if(p->s.size >= nunits){
