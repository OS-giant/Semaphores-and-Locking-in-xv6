...
int main(int argc, char *argv[]){
  ...
  12:	83 ec 44             	sub    $0x44,%esp
    ...
    int pid = fork();
  15:	e8 01 03 00 00       	call   31b <fork>
    if (pid < 0) {
  1a:	85 c0                	test   %eax,%eax
  1c:	78 4b                	js     69 <main+0x69>
  ...
  1e:	75 24                	jne    44 <main+0x44>
        int pid1 = fork();
  20:	e8 f6 02 00 00       	call   31b <fork>
        if(pid1 == 0){
  ...
  37:	50                   	push   %eax
  38:	6a 01                	push   $0x1
  3a:	e8 c4 03 00 00       	call   403 <writer>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	eb 36                	jmp    7a <main+0x7a>
            wait();
        }
    }
        ...
        int pid1 = fork();
  44:	e8 d2 02 00 00       	call   31b <fork>

        if(pid1 == 0) {
  49:	85 c0                	test   %eax,%eax
  4b:	74 49                	je     96 <main+0x96>
            writer(0,&condvar);
        }
  ...
  4d:	50                   	push   %eax
  4e:	50                   	push   %eax
  4f:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  52:	50                   	push   %eax
  53:	6a 00                	push   $0x0
  55:	e8 a1 03 00 00       	call   3fb <reader>
            wait();
  5a:	e8 cc 02 00 00       	call   32b <wait>
  5f:	83 c4 10             	add    $0x10,%esp
        }

        wait();
  62:	e8 c4 02 00 00       	call   32b <wait>
  67:	eb 11                	jmp    7a <main+0x7a>
        printf(1, "Error forking child.\n");
  69:	50                   	push   %eax
  6a:	50                   	push   %eax
  6b:	68 28 08 00 00       	push   $0x828
  70:	6a 01                	push   $0x1
  72:	e8 49 04 00 00       	call   4c0 <printf>
  77:	83 c4 10             	add    $0x10,%esp
    }

    exit();
  7a:	e8 a4 02 00 00       	call   323 <exit>
            reader(1,&condvar);
  7f:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  82:	51                   	push   %ecx
  83:	51                   	push   %ecx
  84:	50                   	push   %eax
  85:	6a 01                	push   $0x1
  87:	e8 6f 03 00 00       	call   3fb <reader>
            wait();
  8c:	e8 9a 02 00 00       	call   32b <wait>
  91:	83 c4 10             	add    $0x10,%esp
  94:	eb e4                	jmp    7a <main+0x7a>
            writer(0,&condvar);
  96:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  99:	52                   	push   %edx
  9a:	52                   	push   %edx
  9b:	50                   	push   %eax
  9c:	6a 00                	push   $0x0
  9e:	e8 60 03 00 00       	call   403 <writer>
  a3:	83 c4 10             	add    $0x10,%esp
  a6:	eb ba                	jmp    62 <main+0x62>
                reader(2,&condvar);
  a8:	50                   	push   %eax
  a9:	50                   	push   %eax
  aa:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  ad:	50                   	push   %eax
  ae:	6a 02                	push   $0x2
  b0:	e8 46 03 00 00       	call   3fb <reader>
                wait();
  b5:	e8 71 02 00 00       	call   32b <wait>
  ba:	83 c4 10             	add    $0x10,%esp
  bd:	eb bb                	jmp    7a <main+0x7a>
  bf:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 3e 08 00 00       	mov    $0x83e,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 f0 0a 00 00       	mov    0xaf0,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 f0 0a 00 00       	mov    %eax,0xaf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 f0 0a 00 00       	mov    0xaf0,%eax
 ...
 7d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7d7:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 f0 0a 00 00 f4 	movl   $0xaf4,0xaf0
 7f7:	0a 00 00 
    base.s.size = 0;
 7fa:	bf f4 0a 00 00       	mov    $0xaf4,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 f4 0a 00 00 f4 	movl   $0xaf4,0xaf4
 806:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 f8 0a 00 00 00 	movl   $0x0,0xaf8
 812:	00 00 00 
    if(p->s.size >= nunits){
