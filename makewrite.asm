...
_makewrite:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  15:	8b 41 04             	mov    0x4(%ecx),%eax
    ...
    make_write(atoi(argv[1]));
  18:	ff 70 04             	pushl  0x4(%eax)
  1b:	e8 10 02 00 00       	call   230 <atoi>
  20:	89 04 24             	mov    %eax,(%esp)
  23:	e8 23 03 00 00       	call   34b <make_write>
...
free(void *ap)
{
 ...
 615:	a1 60 0a 00 00       	mov    0xa60,%eax
{
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 60 0a 00 00    	mov    0xa60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 60 0a 00 00       	mov    0xa60,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 60 0a 00 00       	mov    %eax,0xa60
}
